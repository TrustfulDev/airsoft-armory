        ...
        <div>
            ...
            <FadeIn className={styles.container}>
                ...
                <div className={styles.card_container}>
                    <ContactCard img='/people/phi.PNG' name='Phi Vu' link="https://www.facebook.com/itzphi" />
                    <ContactCard img='/people/justin.PNG' name='Justin Dang' link="https://www.facebook.com/SupItsJustin" />
